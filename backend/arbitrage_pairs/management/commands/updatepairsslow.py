    ...
    def handle(self, *args, **options):
        ...
        while True:
            ...
            for base_coin in tqdm(coins):
                coin_tickers = Cryptorank.get_coin_tickers(coin_id=base_coin.key)
                ...
                for base_ticker in coin_tickers['data']:
                    ...
                    for target_ticker in coin_tickers['data']:
                        if base_ticker != target_ticker:
                            ...
                            scheme, netloc, path, query, fragment = urlsplit(target_ticker['url'])
                            target_ticker['url'] = urlunsplit((scheme, netloc, path, '', ''))
